...
namespace ARM.Logistics.Payments.Square.Components
{
    ...
    public class PaymentSquareViewComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            {
                var cardNumberMask = await _localizationService.GetResourceAsync("ARM.Logistics.Payments.Square.Fields.StoredCard.Mask");
            ...
            {
                var selectCardText = await _localizationService.GetResourceAsync("ARM.Logistics.Payments.Square.Fields.StoredCard.SelectCard");
            ...
            return View("~/Plugins/Logistics.Payments.Square/Views/PaymentInfo.cshtml", model);
        }
