...
namespace ARM.Logistics.Payments.Square.Models
{
    ...
    public record PaymentInfoModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("ARM.Logistics.Payments.Square.Fields.PostalCode")]
        public string PostalCode { get; set; }

        [NopResourceDisplayName("ARM.Logistics.Payments.Square.Fields.SaveCard")]
        public bool SaveCard { get; set; }

        [NopResourceDisplayName("ARM.Logistics.Payments.Square.Fields.StoredCard")]
